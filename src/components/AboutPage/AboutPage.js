...
const AboutPage = () => (
  <div>
    <div>
      ...
      <br></br>
        <br></br>
      I would like to digitize this process. My app would allow a user to login or create an account. Once an account is created, the user would be directed to the user home page where they will be able to choose a survey. The first survey will have three pages to collect a total of nine data inputs. Once data is collected the user will be brought to a summary page where they can choose to edit or delete the most recently completed survey. Once the survey is completed, the user will be brought back to their home page. In addition to the surveys, admins will be given access to delete any user account, as well as pull statistics from the database.
